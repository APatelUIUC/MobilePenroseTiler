      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-4 pb-16 pt-20 sm:px-6 lg:px-10">
        <header className="space-y-6 text-center sm:text-left">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Tile the plane with Penrose, Einstein hats, triangles, or hexagons.
          </h1>
          <p className="mx-auto max-w-3xl text-base leading-relaxed text-slate-300 sm:mx-0 sm:text-lg">
            Pick a tiling family, tweak its structure, and remix colors on the fly. From the 2023
            Einstein monotile and classic Penrose rhombi to skewed triangle meshes and honeycomb
            grids, every view exports as a crisp, high-res PNG in seconds.
          </p>
        </header>
        <TilerApp />
